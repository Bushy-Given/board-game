...
public class BoardControllerPlayTest {
    ...
    @Test
    public void whenPlayerOnePlayAndDoNotEndInmainBucket_shouldNextBePlayerTwoAndReturnOk() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.playerOne.mainBucket.stones").value(1))
                ...
                .andExpect(jsonPath("$.playerTwo.mainBucket.stones").value(0));
    }

    @Test
    public void whenPlayerTwoPlayAndDoNotEndInmainBucket_shouldNextBePlayerOneAndReturnOk() throws Exception {
        Board board = boardRepository.save(new Board());
        board.setNext(PlayerTurn.TWO);
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.playerOne.mainBucket.stones").value(0))
                .andExpect(jsonPath("$.playerTwo").isNotEmpty())
                ...
                .andExpect(jsonPath("$.playerTwo.mainBucket.stones").value(1));
    }
    ...
    public void whenCleanPlayerPits_shouldFinishGameAndReturnOk() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.playerTwo.mainBucket.stones").value(41));
    }

    @Test
    public void whenEndsInmainBucket_shouldSamePlayerBeNextAndReturnOk() throws Exception {
        Board board = boardRepository.save(new Board());
